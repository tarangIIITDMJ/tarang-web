          ...
          >
            ...
            <Stack align="flex-start" gap="2rem">
              <Text c="#E5E7EA" fz={isMobileView ? "1rem" : "2rem"} fw={500}>
                It's simple! When your friends or group sign up, they just need
                to enter {!isMobileView && <br />} your user ID in the referral
                code tab.
              </Text>
              <Box>
            ...
            <Text c="#E5E7EA" fz={isMobileView ? "1rem" : "2rem"} fw={500}>
              The more referrals, the bigger the rewards! Start spreading the
              word
